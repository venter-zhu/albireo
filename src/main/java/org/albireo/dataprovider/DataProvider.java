...
import org.albireo.dataprovider.config.CompositeConfig;
import org.albireo.dataprovider.config.ConfigComponent;
import org.albireo.dataprovider.config.DimensionConfig;
import org.albireo.dataprovider.expression.NowFunction;
...
import org.albireo.services.RoleService;
import org.albireo.util.NaturalOrderComparator;
...
public abstract class DataProvider {
    ...
    public String getLockKey() {
        ...
        return Hashing.sha256().newHasher().putString(dataSourceStr + queryStr, Charsets.UTF_8).hash().toString();
    }
