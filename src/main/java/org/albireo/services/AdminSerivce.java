...
public class AdminSerivce {
    ...
    public AdminSerivce(UserDao userDao, RoleDao roleDao, DatasetDao datasetDao, WidgetDao widgetDao, BoardDao boardDao) {
    ...
    public String addUser(String userId, String loginName, String userName, String userPassword) {
        String md5 = Hashing.sha256().newHasher().putString(userPassword, Charsets.UTF_8).hash().toString();
    ...
    public ServiceStatus changePwd(String userId, String curPwd, String newPwd, String cfmPwd) {
        curPwd = Hashing.sha256().newHasher().putString(curPwd, Charsets.UTF_8).hash().toString();
        newPwd = Hashing.sha256().newHasher().putString(newPwd, Charsets.UTF_8).hash().toString();
        cfmPwd = Hashing.sha256().newHasher().putString(cfmPwd, Charsets.UTF_8).hash().toString();
