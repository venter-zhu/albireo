...
public class ConfigRuleService {
    ...
    @Around("execution(* org.albireo.services.WidgetService.save(..)) || " +
            "execution(* org.albireo.services.WidgetService.update(..)) || " +
            "execution(* org.albireo.services.WidgetService.delete(..))")
    ...
    @Around("execution(* org.albireo.services.DatasetService.save(..)) || " +
            "execution(* org.albireo.services.DatasetService.update(..)) || " +
            "execution(* org.albireo.services.DatasetService.delete(..))")
    ...
    @Around("execution(* org.albireo.services.DatasourceService.save(..)) || " +
            "execution(* org.albireo.services.DatasourceService.update(..)) || " +
            "execution(* org.albireo.services.DatasourceService.delete(..))")
    ...
    @Around("execution(* org.albireo.services.BoardService.save(..)) || " +
            "execution(* org.albireo.services.BoardService.update(..)) || " +
            "execution(* org.albireo.services.BoardService.delete(..))")
    ...
    @Around("execution(* org.albireo.services.CategoryService.save(..)) || " +
            "execution(* org.albireo.services.CategoryService.update(..)) || " +
            "execution(* org.albireo.services.CategoryService.delete(..))")
    ...
    @Around("execution(* org.albireo.services.AdminSerivce.addUser(..)) || " +
            "execution(* org.albireo.services.AdminSerivce.updateUser(..)))")
    ...
    @Around("execution(* org.albireo.services.AdminSerivce.addRole(..)) || " +
            "execution(* org.albireo.services.AdminSerivce.updateRole(..)) || " +
            "execution(* org.albireo.services.AdminSerivce.updateRoleRes(..))")
    ...
    @Around("execution(* org.albireo.services.AdminSerivce.updateRole(..))")
    ...
    @Around("execution(* org.albireo.services.AdminSerivce.updateUserRole(..)) ||" +
            "execution(* org.albireo.services.AdminSerivce.deleteUserRoles(..))")
    ...
    @Around("execution(* org.albireo.services.AdminSerivce.updateRoleResUser(..))")
